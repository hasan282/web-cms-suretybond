        ...
        <div style="background-color:#ffffff;max-width: 600px;margin-left: auto;margin-right:auto;border: solid 1px #deeaff;padding:10px">
            ...
            <div style="text-align:center">
                <a target="_blank" href="<?= $mail_link; ?>">
                    <div style="background-color:#0a66c2;border:0;border-radius:100px;box-sizing:border-box;color:#ffffff;cursor:pointer;display:inline-flex;font-size:16px;font-weight:600;line-height:20px;max-width:480px;min-height:40px;min-width:0px;overflow:hidden;padding:15px;padding-left:20px;padding-right:20px;text-align:center"><?= $button_text; ?></div>
                </a>
            </div>
